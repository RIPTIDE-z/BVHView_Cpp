...
void CapsuleDataInit(CapsuleData* data)
{
    *data = {};
    ...
    data->aoLookupResolution = Vector2{
        static_cast<float>(data->aoLookupImage.width),
        static_cast<float>(data->aoLookupImage.height)};
    ...
    data->shadowLookupResolution = Vector2{
        static_cast<float>(data->shadowLookupImage.width),
        static_cast<float>(data->shadowLookupImage.height)};
